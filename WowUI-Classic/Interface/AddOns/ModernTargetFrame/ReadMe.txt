...
v1.13 (2023-08-22)
	-Fixed health obfuscation being backported from TBC
	-Fixed Blizzard backporting Dragon Flight's options system to Vanilla Classic

v1.12 (2022-10-10)
	-Dropped WotLK Classic support as the Default UI has caught up to this addon's features
	-Native code no longer uses ShouldKnowUnitHealth() in WotLK Classic
