...
function skin:OnEnable()
  ...
  self:ApplySkin(mainColor, cornerIconColor, castBarColor, 1)
end
...
function skin:OnDisable()
  ...
  local color = {1,1,1,1}
  self:ApplySkin(color, color, color, 0)
end
...
function skin:ApplySkin(mainColor, cornerIconColor, castBarColor, desaturation)
  -- Frame Textures.
  ...
  if classPowerBars[private.playerInfo.class] then
    classPowerBars[private.playerInfo.class](mainColor, desaturation)
  end
